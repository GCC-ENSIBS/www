...
description: "Retour court sur une élévation de privilèges physique via GRUB : éditer la ligne de boot, obtenir un shell root et rappeler pourquoi chiffrer la LVM compte."
publicationDate: 2023-03-24 00:00:00+0000
cover: ../../../assets/blog/fastest-grub-privilege-escalation/grub.jpg
coverAlt: "L'élévation de privilèges la plus rapide sur GRUB"
categories:
